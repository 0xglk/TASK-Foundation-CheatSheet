...
- `{ }`: is mainly used for `Deconstruct an object, Enclose blocks `
- `( )`: is mainly used for `function calls, conditional statements, grouping to enforce Order of Operations.`
- `[ ]`: is mainly used for `Arrays, Elements of an Array`
...
return array.length; // returns number of elements in the array
...
The structure of object is a pair of `index:key`
